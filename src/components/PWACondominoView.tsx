  ...
  return (
    ...
    >
      ...
      >
        ...
        {activeTab === "perfil" && (
          <div className="space-y-4 animate-fade-in" id="pwa-modulo-perfil">
            ...
            {(() => {
              const contaPrincipalPerfil = contas.find(c => c.is_principal) || contas[0];
              const ibanPredio = contaPrincipalPerfil?.iban || predio.iban || "IBAN não configurado — contacte a administração";
      ...
      {/* PWA NATIVE BOTTOM NAVIGATION BAR (Specially customized for 5 key views with CondoManager AI colors) —
          fixa ao fundo do ecrã real (fixed, não shrink-0 dentro do flow),
          com padding extra para a seat area do telemóvel (notch inferior) —
