...
export function PWASimulator({
  ...
  return (
    <div className="w-full h-full">
      ...
      {/* Nesta secção deixou de haver uma moldura de telemóvel falsa (com
          entalhe, altifalante e barra de estado simuladas) nem o painel de
          instruções de teste ao lado — isto só fazia sentido quando um
          administrador via o simulador num ecrã de PC largo, lado a lado
          com o guia. Desde que o routing passou a ser por dispositivo, este
          componente só é montado quando o ecrã já É um telemóvel real, que
          já tem o seu próprio entalhe e barra de estado — mostrar uma
          moldura e uma barra de estado falsas por cima ficava a duplicar
          tudo e a parecer uma ferramenta de testes, não a app real. */}
          ...
          >
            ...
            <div className="bg-slate-950 px-3 py-1.5 shrink-0 flex items-center justify-between border-b border-slate-800 shadow-lg z-10 h-[58px] overflow-hidden">
              ...
              <div className="flex items-center space-x-1.5">
                ...
                {/* Termina a sessão real (não só o estado local do
                    simulador) — antes só marcava pwaIsLoggedOut a true, o
                    que mostrava um ecrã de "sessão terminada" sem realmente
                    fazer logout, deixando a sessão real aberta. */}
                <button
                  onClick={() => {
